...
export default function NewPostPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...prev,
        feature_image_url: json.secure_url,
      }));
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(formData.is_published ? "Post published." : "Draft saved.");
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full border-b border-neutral-300 bg-transparent pb-3 text-2xl font-semibold outline-none transition-colors focus:border-black placeholder:text-neutral-300"
            />
            ...
            {formData.slug && (
              <p className="font-mono text-[10px] tracking-[0.12em] text-neutral-400">
                /blog/
                <span className="text-neutral-600">{formData.slug}</span>
              </p>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="min-h-25 w-full border border-neutral-300 bg-[#fafafa] p-4 outline-none transition-colors focus:border-black"
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            {isPreview ? (
              ...
              <textarea
                ...
                className="min-h-125 w-full border border-neutral-300 bg-[#fafafa] p-6 font-mono text-sm outline-none transition-colors focus:border-black"
              />
            )}
          </div>
