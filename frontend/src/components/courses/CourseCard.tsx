...
export default function CourseCard({ material }: Props) {
  return (
    <a
      ...
      className="group block overflow-hidden rounded-2xl border border-white/20 bg-white backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:bg-white/30 dark:border-white/10 dark:bg-white/5"
    >
