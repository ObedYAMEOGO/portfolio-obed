...
export default function MaterialsTable({
  ...
  const renderIcon = (material: Material) => {
  ...
  const renderContext = (material: Material) => {
    ...
    return material.video_context === "PLAYLIST" ? "Playlist" : "Single video";
  };
    ...
    <section className="overflow-hidden rounded-xl border border-neutral-200 bg-white">
      ...
      {materials.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-2 py-16">
          <p className="text-sm text-neutral-400">No materials yet.</p>
        </div>
      ) : (
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-neutral-100 bg-neutral-50">
                {["Type", "Title", "Category", "Context", "Created", ""].map((header) => (
                  <th
                    key={header}
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[11px] text-neutral-400">#{material.id}</p>
                    </div>
                  </td>
